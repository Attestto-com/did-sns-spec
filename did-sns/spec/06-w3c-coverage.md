...
| [Preempt / limit trackable data trails](https://www.w3.org/TR/2021/NOTE-did-use-cases-20210317/#limitTrack) | **Covered** | SD-JWT per-field selective disclosure. On-chain queries carry no PII. Each DID is independent; the user decides which to present. Off-chain PII vaults (2-of-2 XOR encrypted) ensure personal data never touches the public ledger. |
